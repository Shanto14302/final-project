(function (j) {
    ...
    q.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5 mr-2", 
        text: function (a) {
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            c.autoFilter && j("definedNames", m).append(n(m, "definedName", { attr: { name: "_xlnm._FilterDatabase", localSheetId: "0", hidden: 1 }, text: G(c) + "!$A$" + d + ":" + x(k.header.length - 1) + h }));
