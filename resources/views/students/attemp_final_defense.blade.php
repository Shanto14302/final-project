                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="card-title">Final Defense Information</h4>
                                    <hr>
                                    ...
                                    <p>
                                        {!! $student->phase_final_defence_instruction !!}
                                    </p>
                                </div>
                                @if($student->phase_status==3)
                                <div class="col-lg-6">
                                    <h4 class="card-title">Final Defense Form</h4>
                                    <hr>
                                    @if ($student->phase_final_defence_file==NULL && $student->phase_final_defence_start_date>=date('Y-m-d'))


                                    <form action="{{ route('attemp_final_defense') }}" class="theme-form" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                    ...
                                    @else
                                        @if ($student->phase_final_defence_start_date<date('Y-m-d'))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mt-2">
                                                ...
                                                <a target="__blank" href="{{ asset($student->phase_final_defence_file) }}" class="btn btn-info btn-sm mt-4"> Click here to download slide</a>
                                            </div>
                                            ...
                                            <div class="col-lg-12 mt-2">
                                                <label for="">Description</label>
                                                <textarea name="description" id="summernote4" class="form-control" readonly disabled>{!! $student->phase_final_defence_description !!}</textarea>
                                            </div>
                                ...
                                @elseif($student->phase_status==2)
                                Your are in pre defense
                                @else
                                <div class="col-lg-6">
                                    <h4 class="card-title">final defense successfully completed</h4>
                                    <div class="row">
    ...
    <script>
     ...
     <script>
         $(document).ready(function(){
             ...
             toastr["success"]("Final defense data updated successfully")
         });
     </script>
     @endif
