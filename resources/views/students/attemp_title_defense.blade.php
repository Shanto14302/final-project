                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="card-title">Title Defense Information</h4>
                                    <hr>
                                    ...
                                    <p>
                                        {!! $student->phase_title_defense_instruction !!}
                                    </p>
                                </div>
                                @if($student->phase_status==1)
                                <div class="col-lg-6">
                                    <h4 class="card-title">Title Defense Form</h4>
                                    <hr>
                                    @if ($student->phase_title_defense_type==NULL && $student->phase_title_defence_start_date>=date('Y-m-d'))


                                    <form action="{{ route('attemp_title_defense') }}" class="theme-form" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <select name="defense_type" id="" class="form-control" required >
                                                    ...
                                                    <option value="Research based project">Research based project</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-lg-12">
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea class="form-control" id="summernote2" name="objective" required>

                                                </textarea>
                                            </div>
                                            <div class="form-group col-lg-12">
                                                <label for="">Motivation</label>
                                                <textarea class="form-control" id="summernote3" name="motivation" required>
                                    ...
                                    @else
                                        @if ($student->phase_title_defence_start_date<date('Y-m-d'))
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label for="">Type</label>
                                                <select name="defense_type" id="" class="form-control" readonly disabled>
                                            ...
                                            <div class="col-lg-12 mt-2">
                                                <label for="">Description</label>
                                                <textarea name="description" id="summernote4" class="form-control" readonly disabled>{!! $student->phase_title_defense_description !!}</textarea>
                                            </div>
                                            <div class="col-lg-12 mt-2">
                                                <label for="">Objective</label>
                                                <textarea name="objective" id="summernote5" class="form-control" readonly>{!! $student->phase_title_defense_objective !!}</textarea>
                                            </div>
                                            <div class="col-lg-12 mt-2">
                                                <label for="">Motivation</label>
                                                <textarea name="motivation" id="summernote6" class="form-control" readonly>{!! $student->phase_title_defense_motivation !!}</textarea>
                                            </div>
                                        </div>
                                ...
                                @else
                                <div class="col-lg-6">
                                    <h4 class="card-title">Title defense successfully completed</h4>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label for="">Type</label>
                                            <select name="defense_type" id="" class="form-control" readonly disabled>
    ...
    <script>
     ...
     <script>
         $(document).ready(function(){
             ...
             toastr["success"]("Title defense data updated successfully")
         });
     </script>
     @endif
