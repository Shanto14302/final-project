        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Final Defense</h4>
                                ...
                                <thead>
                                    ...
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($student->phase_final_defence_file!=NULL && $student->phase_final_defence_status=='Final')
                                                    <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#accept_title_modal{{ $student->phase_id }}">View</a>
                                                @endif
                                                @if ($student->phase_final_defence_file!=NULL)
                                                <a class="btn btn-info btn-sm" onclick="return confirm('Are you sure want to publish ?')" href="{{ route('publish_final_result',$student->phase_id) }}" >Publish Final Result</a>
                                                @endif
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('update_final_defense') }}" method="POST" >
                                                            @csrf
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 mt-2">
                                                                    ...
                                                                    <textarea name="description" id="summernote" class="form-control" >{!! $student->phase_final_defence_description !!}</textarea>
                                                                </div>

                                                                <div class="col-lg-12 mt-2">
                                                                    <label for="">Remark</label>
                                                                    <input type="number" min="0" max="100" name="remark" class="form-control" value="{{ $student->phase_final_defence_remark }}">
                                                                </div>
                                                            </div>
