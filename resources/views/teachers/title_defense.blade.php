        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Title Defense</h4>
                                ...
                                <thead>
                                    ...
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                Start : {{ $student->phase_title_defence_start_date }} <br>
                                                End : {{ $student->phase_title_defence_end_date }}
                                            </td>
                                            <td>
                                                @if ($student->phase_defence_topic!=NULL && $student->phase_title_defence_status=='Title')
                                                    <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#accept_title_modal{{ $student->phase_id }}">View</a>
                                                @endif

                                                <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#edit_modal{{ $student->phase_id }}">Pre-defense</a>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('update_title_defense_status') }}" method="POST" >
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <label for="">Pre-defense Date</label>
                                                                    <input type="date" name="start_date" class="form-control" required>
                                                                    <input type="hidden" name="phase_id" class="form-control" value="{{ $student->phase_id }}">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label for="">Pre-defense Time</label>
                                                                    <input type="time" name="end_date" class="form-control" required>
                                                                </div>
                                                                <div class="col-lg-12 mt-2">
                                                                    <label for="">Pre-defense Instruction</label>
                                        ...
                                        <div class="modal fade bd-example-modal" id="accept_title_modal{{ $student->phase_id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('update_title_defense') }}" method="POST" >
                                                            @csrf
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 mt-2">
                                                                    ...
                                                                    <textarea name="description" id="summernote" class="form-control" required>{!! $student->phase_title_defense_description !!}</textarea>
                                                                </div>
                                                                <div class="col-lg-12 mt-2">
                                                                    <label for="">Objective</label>
                                                                    <textarea name="objective" id="summernote2" class="form-control" required>{!! $student->phase_title_defense_objective !!}</textarea>
                                                                </div>
                                                                <div class="col-lg-12 mt-2">
                                                                    <label for="">Motivation</label>
                                                                    <textarea name="motivation" id="summernote3" class="form-control" required>{!! $student->phase_title_defense_motivation !!}</textarea>
                                                                </div>
                                                                <div class="col-lg-12 mt-2">
                                                                    <label for="">Remark</label>
                                                                    <input type="number" min="0" name="remark" class="form-control" value="{{ $student->phase_title_defence_remark }}">
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit" id="update_basic_info_button"
    ...
    <script>
     ...
     <script>
         $(document).ready(function(){
             ...
             toastr["success"]("Pre defense updated successfully")
         });
     </script>
     @endif
